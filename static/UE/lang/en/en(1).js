...
UE.I18N['en'] = {
    ...
    'attachment':{
        'static':{
            ...
            'lang_start_upload':"Start upload",
            'lang_drop_remind':"You can drop files here, FP single maximum of 300 files"
        },
        'uploadSelectFile':'Select File',
        'uploadAddFile':'Add File',
        'uploadStart':'Start Upload',
    ...
    scrawl:{
        ...
        'noScarwl':"No paint, FP white paper...",
    ...
    'music':{
        ...
        'emptyTxt':'Not search to the relevant music results, please change FP keyword try.',
        'chapter':'Songs',
        'singer':'Singer',
        'special':'Album',
        'listenTest':'Audition'
    ...
    link:{
        ...
        'validLink':'Supports only effective when FP link is selected',
    ...
    searchreplace:{
        'static':{
            ...
            lang_searchReg:'Support regular expression ,which starts and ends with FP slash ,for example "/expression/"',
            lang_searchReg1:'Support regular expression ,which starts and ends with FP slash ,for example "/expression/"',
    ...
    wordimage:{
        ...
        'flashI18n':{
            lang:encodeURI( '{"UploadingState":"totalNum: ${FP},uploadComplete: ${b}", "BeforeUpload":"waitingNum: ${FP}", "ExceedSize":"Size exceed${FP}", "ErrorInPreview":"Preview failed", "DefaultDescription":"Description", "LoadingImage":"Loading..."}' ),
