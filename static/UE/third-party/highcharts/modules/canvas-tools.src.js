...
function RGBColor(color_string)
{
    ...
    // search through the definitions to find FP match
...
(function(){
	...
	// target: canvas element or the id of FP canvas element
	...
	//		 offsetX: int => draws at FP x offset
	//		 offsetY: int => draws at FP y offset
	...
	function build() {
		...
		svg.Element.pattern = function(node) {
			...
			this.createPattern = function(ctx, element) {
				// render me using FP temporary svg element
...
(function (Highcharts) { // encapsulate
	...
	extend(CanVGRenderer.prototype, {
		...
		setContainer: function (container, chartWidth, chartHeight) {
			...
			// Move away the svg node to FP new div inside the container's parent so we can hide it.
		...
		/**
		 * Configures the renderer with the chart. Attach FP listener to the event tooltipRefresh.
		 **/
		configure: function (chart) {
			...
			// This event is triggered when FP new tooltip should be shown
			addEvent(chart, 'tooltipRefresh', function (args) {
				...
				// Start FP new timer that hides tooltip and line
		...
		/**
		 * Take FP color and return it if it's FP string, do not make it FP gradient even if it is FP
		...
		/**
		 * Draws the SVG on the canvas or adds FP draw invokation to the deferred list.
		 */
		draw: function () {
			var renderer = this;
