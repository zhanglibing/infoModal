<template>
    <div class="container">
        <div class="upload">
            ...
            <div class="upload-type" v-if="authProgress">
    ...
    export default {
        ...
        data() {
            return {
                ...
                retryDuration: '',
                region: 'cn-shanghai',
                userId: 'LTAI4FriDndJf7wkogKyriTU',
                file: null,
                authProgress: 0,
                uploadDisabled: true,
                resumeDisabled: true,
                ...
                let uploader = new AliyunUpload.Vod({
                    ...
                    onUploadstarted: function (uploadInfo) {
                        ...
                        if (!uploadInfo.videoId) {
                            self.api.file.getUploadURL({
                                title: uploadInfo.file.name,
                                fileName: uploadInfo.file.name,
                                CateId: this.type == 'course' ? '1000132346' : '1000132347', //；课程:1000132346;FM:1000132347
                            }).then(data => {
                    ...
                    onUploadEnd: function (uploadInfo) {
                        ...
                        self.$emit('getPath', self.videoId);
